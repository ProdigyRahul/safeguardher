...
import { ArrowLeftIcon, ChevronDownIcon } from "react-native-heroicons/solid"; // Assuming you have the ChevronDownIcon imported
  ...
  return (
    <View style={[tw`flex-1 bg-white`, { backgroundColor: "#fdd9e4" }]}>
      ...
      >
        ...
        >
          <Text style={{ fontSize: 16, color: "#554288", fontWeight: "bold" }}>
        ...
        >
          <Text style={{ fontSize: 12, color: "#C0C0C0", textAlign: "center" }}>
